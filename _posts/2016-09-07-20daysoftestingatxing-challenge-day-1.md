...
-  **PAIR WITH SOMEONE OUTSIDE YOUR BUSINESS UNIT OR OUTSIDE QA**
- ** GIVE SOMEONE POSITIVE FEEDBACK OUTSIDE OF QA**
-  **HAVE LUNCH TOGETHER AND POST A PICTURE**
-  **AUTOMATE ONE WORKFLOW FROM ANOTHER ****BUSINESS UNIT **** (Pairing allowed, but be the driver)**
- ** PERSONAL CHOICE (Testing related, surprise us!)**
...
- **TEST YOUR PRODUCT FOR A QUALITY CRITERIA, WHICH NORMALLY IS NOT A FOCUS IN YOUR ****BUSINESS UNIT**
