...
<p><strong>Quality Conscious Software Delivery (QCSD)</strong> — together with its Agentic evolution ("Agentic QCSD") and the concept of <strong>Designed Agency</strong> — is an original framework conceived and authored by <strong>Lalit Bhamare</strong>, who is responsible for its particular synthesis, models, terminology, structure, and written specification. It was first published in 2022, when the original QCSD paper received the <a href="https://huddle.eurostarsoftwaretesting.com/resources/test-management/quality-conscious-software-delivery/" target="_blank" rel="noopener">EuroSTAR Best Paper Award</a>. This page is published from the author's own independent channel as a public, timestamped record of that authorship.</p>

<p>QCSD stands on the shoulders of the wider testing and quality community. It synthesises and builds upon established ideas — including <a href="https://en.wikipedia.org/wiki/Gerald_Weinberg" target="_blank" rel="noopener">Jerry Weinberg</a>'s work on quality and systems thinking, and the Rapid Software Testing methodology developed by <a href="https://www.wiley.com/en-us/Taking+Testing+Seriously%3A+The+Rapid+Software+Testing+Approach-p-9781394253197" target="_blank" rel="noopener">James Bach and Michael Bolton</a>, among others. Those foundational works remain the intellectual property of their respective authors, are credited to them, and are <strong>not</strong> claimed here. The authorship and licence below apply only to Lalit Bhamare's own original contributions to QCSD — not to any third-party work it references, incorporates, or draws upon, which remains under the rights and licences of its respective authors.</p>

<div class="qcsd-license">
<p>© 2022–2026 Lalit Bhamare. Lalit Bhamare's <strong>own original contributions to QCSD</strong> — the synthesis, models, terminology, and written content on this page — are licensed under <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener">Creative Commons Attribution 4.0 International (CC BY 4.0)</a>. You are free to share and adapt that material for any purpose, including commercially, provided you give appropriate credit to Lalit Bhamare, link to the licence, and indicate if changes were made. This licence does not extend to any third-party works referenced or incorporated.</p>
<p>Any accompanying <strong>source code and reference implementations</strong> authored by Lalit Bhamare are licensed separately under the <a href="https://opensource.org/license/mit" target="_blank" rel="noopener">MIT License</a>.</p>
